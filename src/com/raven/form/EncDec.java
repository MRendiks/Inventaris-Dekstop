...
public class EncDec {
		...
		void encrypt(String filename,String dirname,String key, int mode)			//encrypt function
		{
			try{
				...
				FunctionSet.rounds(in, outTemp, key, shiftby,"Encrypting", mode);	//xor
		...
		void decrypt(String filename,String extname, String dirname,String key, int mode) //decrypt fxn
		{
			try{
				File dir = new File("TempFiles");
				if(!dir.exists())
				...
				FunctionSet.rounds(in, out, key, shiftby,"Decrypting",mode);	//xor
