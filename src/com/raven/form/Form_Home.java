...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        EventAction eventAction = new EventAction() {
            ...
            public void delete(ModelStudent student) {
                if (showMessage("Hapus Data : " + student.getName())) {
            ...
            public void update(ModelStudent student) {
                if (showMessage("Update Data : " + student.getName())) {
                    System.out.println("User click OK");
                } else {
                    System.out.println("User click Cancel");
                }
        ...
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/raven/icon/profile.jpg")), "Mahinda", "Laki-laki", "Data Rumah",  300).toRowTable(eventAction));
    }

    private void initCardData() {
        Icon icon1 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.PEOPLE, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card1.setData(new ModelCard("Data Baru Notaris", 5100, 20, icon1));
        Icon icon2 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.MONETIZATION_ON, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card2.setData(new ModelCard("Pendapatan", 2000, 60, icon2));
        Icon icon3 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.SHOPPING_BASKET, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card3.setData(new ModelCard("Data Rmah", 3000, 80, icon3));
        Icon icon4 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.BUSINESS_CENTER, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card4.setData(new ModelCard("Data Kegiatan", 550, 95, icon4));
    }
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama", "Jenis Kelamin", "Jenis Data", "Harga", "Aksi"
            }
        ) {
        ...
        jLabel5.getAccessibleContext().setAccessibleName("Data Notaris");
